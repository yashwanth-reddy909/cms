...
const { checkPlagiarism } = require('../controllers/plag-controller.js');
...
router.put('/UpdateQuestionResultWithFile/:id', updateQuestionResultWithFile)
...
router.post('/Subject/:id/CreateExam', createSubjectExam);
